...
export default function NavBar() {
    ...
    return (
        <>
            ...
            <div className="fixed top-0 left-0 right-0 h-16 bg-white/70 backdrop-blur-xl border-b border-slate-900/10 z-50">
                <div className="w-full max-w-7xl mx-auto h-full px-4 sm:px-6 lg:px-8 flex items-center justify-between">
                    ...
                    <Link href="/" onClick={handleLinkClick} className="flex-shrink-0">
                        <span className="flex items-center gap-2 text-xl text-slate-800 font-bold leading-none">
                            tncsp
                        </span>
                    </Link>
                    ...
                    <div className="hidden md:flex items-center space-x-4 h-full">
                        <Link href={mainLinks.home.href}>
                            <span className={`text-sm cursor-pointer transition-colors duration-300 px-3 py-1.5 rounded-md
                                             ${pathname === mainLinks.home.href 
                                                ? 'font-semibold bg-slate-900/5 text-slate-900' 
                        ...
                        >
                            ...
                            <div className={`absolute top-[90%] w-40 left-1/2 -translate-x-1/2 pt-2
                                ...
                                <div className="bg-white/90 backdrop-blur-xl border border-slate-900/10 rounded-xl shadow-lg">
                                    <div className="p-2">
            ...
            {/* --- EDIT: Mobile Menu replaced with the style from the reference version --- */}
            <div
