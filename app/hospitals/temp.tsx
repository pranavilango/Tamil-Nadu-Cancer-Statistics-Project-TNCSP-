...
function FilterBox({ filters, onFilterChange, allDistricts, allTreatments, allCosts, allTypes, onClear, onDone }: any) {
...
function HospitalInfoBox({ hospital, onClose }: { hospital: any; onClose: () => void; }) {
...
function MapContainer({ setSelectedHospital, hospitalsToShow }: { setSelectedHospital: (hospital: any) => void; hospitalsToShow: Hospital[]; }) {
